<%@ Page Title="" Language="C#" MasterPageFile="~/secretary/Nodal.master" AutoEventWireup="true" CodeFile="TubewellAllotmentRpt.aspx.cs" Inherits="Nodal_TubewellAllotmentRpt" %>
            ...
            <div class="col-md-12 p-2 table-responsive">
                <asp:GridView ID="gvTubewell" runat="server" AutoGenerateColumns="False" CssClass="table table-hover table-bordered table-sm" GridLines="None"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-Wrap="false" HeaderText="Document" >
                            <ItemTemplate>
