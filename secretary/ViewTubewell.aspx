<%@ Page Title="" Language="C#" MasterPageFile="~/secretary/Nodal.master" AutoEventWireup="true" CodeFile="ViewTubewell.aspx.cs" Inherits="EE_ViewTubewell" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 p-1">
                <a class="btn btn-primary btn-sm" href="ApproveTubewell.aspx">Back</a>
            </div>
            <div class="col-md-12 p-1">
        ...
        <div class="row">
            ...
            <div class="col-md-12 p-1">
                ...
                <asp:Button ID="btnLock" runat="server" Text="Seen" class="btn btn-primary btn-sm" OnClick="btnLock_Click" />
                <asp:Button ID="btnReturn" runat="server" Text="Return" class="btn btn-primary btn-sm" OnClick="btnReturn_Click" />
            </div>
        </div>
    </div>
