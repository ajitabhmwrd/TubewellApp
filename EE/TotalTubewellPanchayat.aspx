<%@ Page Title="" Language="C#" MasterPageFile="~/EE/eeMaster.master" AutoEventWireup="true" CodeFile="TotalTubewellPanchayat.aspx.cs" Inherits="EE_TotalTubewellPanchayat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <br />
        <span class="font-weight-bold small">Total Tube Well List Panchayat wise</span>
        <hr />
    </div>
