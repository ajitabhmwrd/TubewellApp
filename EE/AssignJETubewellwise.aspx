<%@ Page Title="" Language="C#" MasterPageFile="~/EE/eeMaster.master" AutoEventWireup="true" CodeFile="AssignJETubewellwise.aspx.cs" Inherits="EE_AssignJETubewellwise" %>
        ...
        <div class="row">
            ...
            <div class="col-md-12 p-2 ">
                <asp:GridView ID="gvTubewell" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    OnPageIndexChanging="gvTubewell_PageIndexChanging" PageSize="50" AllowPaging="true" OnRowEditing="gvBlock_RowEditing" OnRowCancelingEdit="gvBlock_RowCancelingEdit" 
                    OnRowUpdating="gvBlock_RowUpdating" >
                    <Columns>
