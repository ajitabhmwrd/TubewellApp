...
public partial class EE_TotalTubewellCABlock : System.Web.UI.Page
{
    ...
    public void bindgvTubewell()
    {
        try
        {
            ...
            DataTable dt = gd.getDataTable("getTubewellCAByDistCodeRpt", prm);
            bc.bindGV(gvTubewell, dt);
        }
        catch (Exception ex)
        {
           // Response.Redirect("TubewellHandover.aspx");
        }
    }
}