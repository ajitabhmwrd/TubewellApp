<%@ Page Title="" Language="C#" MasterPageFile="~/EE/eeMaster.master" AutoEventWireup="true" CodeFile="TwAllotmentRequisitionPlan.aspx.cs" Inherits="EE_TwAllotmentRequisitionPlan" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 p-1">
                <a class="btn btn-primary btn-sm" href="AddTwAllotmentRequisitionPlan.aspx">Add Requisition</a>
            </div>
            <div class="col-md-12">
                <asp:GridView ID="gvRequisition" runat="server" AutoGenerateColumns="false" CssClass="tableCust" OnRowDataBound="gvRequisition_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Print">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkPrint" runat="server" Text="View / Print" OnClick="lnkPrint_Click"></asp:LinkButton>
                        ...
                        <asp:TemplateField HeaderText="Forward">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkForward" runat="server" Text="Forward" OnClick="lnkForward_Click"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <ContentTemplate>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 p-1">
                            <asp:Button ID="btnForward" runat="server"  Text="Forward" CssClass="btn btn-primary btn-sm" ValidationGroup="TubewellEntryMP" OnClick="btnForward_Click" />
