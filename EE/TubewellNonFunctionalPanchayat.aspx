<%@ Page Title="" Language="C#" MasterPageFile="~/EE/eeMaster.master" AutoEventWireup="true" CodeFile="TubewellNonFunctionalPanchayat.aspx.cs" Inherits="EE_TubewellNonFunctionalPanchayat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <br />
        <span class="font-weight-bold small">Total Tube Well Non-Functional List</span>
        <hr />
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 p-1">
                <a class="btn btn-primary btn-sm" href="TubewellHandOverByDist.aspx">Back</a>
            </div>
            <div class="col-md-12 p-1">
                ...
                PANCHAYAT : <asp:Label ID="lbPanchayatName" runat="server" ForeColor="Blue" Font-Bold="True" ></asp:Label>
            </div>
