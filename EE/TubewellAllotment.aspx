<%@ Page Title="" Language="C#" MasterPageFile="~/EE/eeMaster.master" AutoEventWireup="true" CodeFile="TubewellAllotment.aspx.cs" Inherits="Nodal_TubewellAllotment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2 p-1">
                Letter Date*
                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtLtDate" Text="(Required)" ErrorMessage="Enter Tube Well Name" ForeColor="Red" ValidationGroup="TubewellEntry" Font-Bold="True" Display="Dynamic"></asp:RequiredFieldValidator>
                ...
                <asp:TextBox ID="txtLtDate" runat="server" CssClass="form-control form-control-sm" autocomplete="off" placeholder="YYYY-MM-DD"></asp:TextBox>
            ...
            <div class="col-md-3 p-1 ">
                ...
                <asp:LinkButton ID="lbDownload" runat="server" OnClick="lnkDownload_Click" Visible="false">Download Previous pdf</asp:LinkButton>
            </div>
            <div class="col-md-2 p-1 ">
                <br />
                ...
                <asp:GridView ID="gvTubewell" runat="server" AutoGenerateColumns="False" CssClass="table table-hover table-bordered table-sm" GridLines="None"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-Wrap="false" >
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkDownload" Text="Download pdf" CommandArgument='<%# Eval("pdfLocation") %>' runat="server" OnClick="lnkDownload_Click"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
