<%@ Page Title="" Language="C#" MasterPageFile="~/EE/eeMaster.master" AutoEventWireup="true" CodeFile="updateOtherEmployee.aspx.cs" Inherits="EE_updateOtherEmployee" %>
            ...
            <div class="container" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 p-1">
                        ...
                        <asp:DropDownList ID="ddlPanchayat" runat="server" CssClass="form-control">
                            <asp:ListItem Value="0">Select</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 p-1">
                        ...
                        <a class="btn btn-primary btn-sm" href="OtherEmloyee.aspx">Cancel</a>
                    </div>
                </div> 
            </div>
        </ContentTemplate>
