<%@ Page Title="" Language="C#" MasterPageFile="~/SE/seMaster.master" AutoEventWireup="true" CodeFile="TwTechnicialList.aspx.cs" Inherits="SE_TwTechnicialList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="padding-left: 16px; padding-right: 16px">
        <span class="font-weight-bold small">Tubewell Empanelment List</span>
        <hr />
    </div>
    <div style="padding-left: 16px; padding-right: 16px">
        <div class="row">
            <div class="col-md-3 p-1">
                <a class="btn btn-primary btn-sm" href="TwAddTecnician.aspx">Add Technician/Supplier</a>
            </div>
