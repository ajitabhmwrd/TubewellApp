<%@ Page Title="" Language="C#" MasterPageFile="~/Nodal/Nodal.master" AutoEventWireup="true" CodeFile="LoginLog.aspx.cs" Inherits="Nodal_LoginLog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 p-2 table-responsive">
                <asp:DropDownList ID="ddlRole" runat="server" CssClass="form-control form-control-sm" AutoPostBack="true" OnSelectedIndexChanged="ddlRole_SelectedIndexChanged">
