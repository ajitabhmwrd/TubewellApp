<%@ Page Title="" Language="C#" MasterPageFile="~/Nodal/Nodal.master" AutoEventWireup="true" CodeFile="AddInspection.aspx.cs" Inherits="JE_AddInspection" %>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 p-1">
                        ...
                        <cc1:CalendarExtender ID="Calendar1" PopupButtonID="txtInspectionDate" runat="server" TargetControlID="txtInspectionDate" Format="yyyy-MM-dd"></cc1:CalendarExtender>
                    </div>
                    <div class="col-md-3 p-1">
                        District*
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" InitialValue="0" runat="server" ControlToValidate="ddlDist" Display="Dynamic" Text="(Select)" ErrorMessage="Select Block" ForeColor="Red" ValidationGroup="TubewellEntry" Font-Bold="True"></asp:RequiredFieldValidator>
