<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master.master" AutoEventWireup="true" CodeFile="RptTubewellWiseAllotmentPlanHQ.aspx.cs" Inherits="Nodal_TubewellWiseAllotmentPlanHQ" EnableEventValidation="false" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Delete">
                                <ItemTemplate>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:Button ID="btnAllotmentDelete" runat="server" Text="Delete" class="btn-primary" OnClick="btnAllotmentDelete_Click" OnClientClick="return confirm('Are you sure to delete!!!')" />
                                        </ContentTemplate>
                                        <Triggers>
                                            <asp:PostBackTrigger ControlID="btnAllotmentDelete" />
                                        </Triggers>
                                    </asp:UpdatePanel>
                                </ItemTemplate>
                            </asp:TemplateField>
