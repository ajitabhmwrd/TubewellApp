...
public partial class Nodal_TubewellWiseAllotmentPlanHQ : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                string FinYr = Context.Items["FinYr"].ToString();
                ddlFinYear.SelectedValue = FinYr;
    ...
    protected void btnAllotmentDelete_Click(object sender, EventArgs e)
    {
        try
        {
            mp1.Show();
            ...
            lblMessageMP.Text= gd.insExecuteSP("deleteTubewellAllotmentHQ", prm);
            bindgvTubewell();
            bindgvAllotment();
        }
        catch (Exception ex)
