            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 p-1">
                        ...
                        <cc1:CalendarExtender ID="Calendar1" PopupButtonID="txtInspectionDate" runat="server" TargetControlID="txtIrrigationDate" Format="yyyy-MM-dd"></cc1:CalendarExtender>
                    </div>
                    ...
                    <div class="col-md-3 p-1">
                        ...
                        <asp:DropDownList ID="ddlVillage" runat="server" CssClass="form-control form-control-sm" AutoPostBack="true" OnSelectedIndexChanged="ddlVillage_SelectedIndexChanged">
                            <asp:ListItem Value="0">Select</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-3 p-1">
                    ...
                    <div class="col-md-3 p-1 ">
                        ...
                        <asp:TextBox ID="txtComment2" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                    </div>
                    <div class="col-md-3 p-1 ">
                        Image 3 Comment
                        ...
                        <asp:TextBox ID="txtComment3" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                    </div>
                    <div class="col-md-3 p-1 ">
                        Image 4 Comment
                        ...
                        <asp:TextBox ID="txtComment4" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 p-1">
