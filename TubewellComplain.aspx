<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="TubewellComplain.aspx.cs" Inherits="TubewellComplain" %>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mt-1">
                        Upload Image2(.jpg only)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:FileUpload ID="fuImage2" runat="server" />
