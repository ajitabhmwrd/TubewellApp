...
public partial class Nodal_CreateAllotment : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            lblMessage.Text = gd.insExecuteSP("insCreateTubewellAllotmentHQ", prm);
            bindgvTubewell();
        }
        catch (Exception ex)
        {
    ...
    public void bindgvTubewell()
    {
        try
        {
            ...
            DataTable dt = gd.getDataTable("getAllotmentBySearchHQ", prm);
    ...
    protected void btnUpdateAllotment_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            gd.insExecuteSP("updTubewellAllotmentHQ", prm);
            reset();
